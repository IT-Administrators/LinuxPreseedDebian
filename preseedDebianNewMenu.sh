...
# There is also a menu entry created named "Automated - Destructive" which installs the system
...
# Append new menu entry to installer menu.
cp preseed.cfg $isoDir/new-iso
cat >> $isoDir/new-iso/boot/grub/grub.cfg <<EOF
menuentry --hotkey=s 'Automated - DESTRUCTIVE' {
